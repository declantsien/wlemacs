...
extern bool wlc_defined_color (struct frame *, const char *,
				Emacs_Color *, bool, bool);
extern void wlc_query_color (struct frame *, Emacs_Color *);
extern void wlc_query_colors (struct frame *, Emacs_Color *, int);
extern int wlc_decode_color (struct frame *f, Lisp_Object color_name,
			    int mono_color);

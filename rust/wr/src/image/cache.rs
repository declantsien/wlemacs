use super::{ImageExt, ImageRef, WrPixmapRef};
use crate::color::color_to_rgba;
use emacs_sys::bindings::{Fequal, EMACS_UINT};
use emacs_sys::globals::{Qnil, Qsvg};
use emacs_sys::lisp::LispObject;
use image::codecs::gif::GifDecoder;
use image::codecs::pnm::{PnmDecoder, PnmSubtype};
use image::codecs::webp::WebPDecoder;
use image::error::{ImageFormatHint, UnsupportedError, UnsupportedErrorKind};
use image::imageops::FilterType;
use image::io::Reader;
use image::{AnimationDecoder, DynamicImage, ImageError, ImageResult, Rgba};

...
use crate::bindings::{build_string, pvec_type, terminal, Fselected_frame};
use crate::globals::{Qnil, Qterminal_live_p};
...
impl TerminalRef {
    ...
    pub fn display_info(self) -> DisplayInfoRef {
        ...
        return DisplayInfoRef::new(unsafe { self.display_info.wlc });
        unimplemented!();
    }
}
